...
public class TaskCategoryRestController {
    ...
    public ResponseEntity<TaskCategoryResponseDto.TaskCategoryDtoList> getTaskCategoryList() {
        // todo : 멤버가 속한 회사의 업무 카테고리를 내려주기
        List<TaskCategory> taskCategoryList = taskCategoryService.findByMember(MemberUtil.mockMember());
